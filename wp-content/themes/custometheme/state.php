                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="main-slider__content">
                                ...
                                <h2 class="main-slider__title"><?php the_field('state');?></h2>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-one__left">
                            ...
                            <p class="about-one__text-2"><?php the_field('state');?> sit amet, consectetur adipisicing elit, sed
                        ...
                        <div class="project-one__single">
                            <div class="project-one__inner">
                                ...
                                <div class="project-one__content">
                                    <span class="project-one__tagline"><?php the_field('state');?></span>
        ...
        <section class="waste-materials">
            <div class="container">
                <div class="waste-materials__inner">
                    <!-- <div class="project-one__single" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/images/project/project-one-2.jpg);"></div> -->
                    <!-- <div class="waste-materials-shape-1 float-bob-y"><img src="<?php echo get_template_directory_uri();?>/assets/images/project/project-one-1.jpg" alt=""></div> -->
